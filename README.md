...
---
## Как запустить (Для запуска в браузере)
...
- Для установки **автокликера** установите [этот скрипт](https://github.com/mudachyo/1win-Token/raw/main/1win-autoclicker.user.js)
- Открыть [Бота 1win](https://web.telegram.org/k/#?tgaddr=tg%3A%2F%2Fresolve%3Fdomain%3Dtoken1win_bot%26appname%3Dstart%26startapp%3DrefId2475526) и запустить игру
---
